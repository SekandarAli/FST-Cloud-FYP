...
class vertical_recycle_main_adapter(var items : ArrayList<vertical_recycle_main_model>,context
                : Context) : RecyclerView.Adapter<vertical_recycle_main_adapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): vertical_recycle_main_adapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder:vertical_recycle_main_adapter.ViewHolder, position: Int) {
